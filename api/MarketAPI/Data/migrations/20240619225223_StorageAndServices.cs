...
{
    /// <inheritdoc />
    public partial class StorageAndServices : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Storage_Client_IdClient",
                        column: x => x.IdClient,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Produto_Storage_StorageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Produto_StorageId",
                table: "Produto",
                column: "StorageId");

            migrationBuilder.CreateIndex(
                name: "IX_Storage_IdClient",
                table: "Storage",
                column: "IdClient");
        }
